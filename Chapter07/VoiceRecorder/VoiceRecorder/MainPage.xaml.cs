    ...
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void stopRecord_Click(object sender, EventArgs e)
        {
            if (Microphone.Default.State == MicrophoneState.Started)
            {
                ...
                recordingList.Items.Add(new VoiceRecording { Title = filename, Date = DateTime.Now });
        ...
        private void DisplayRecordingNames()
        {
            using (var storage = IsolatedStorageFile.GetUserStoreForApplication())
            {
                ...
                foreach (var filename in filenames)
                {
                    ...
                    recordingList.Items.Add(new VoiceRecording { Title = filename, Date = lastWrite.DateTime });
                }
            }
        }
