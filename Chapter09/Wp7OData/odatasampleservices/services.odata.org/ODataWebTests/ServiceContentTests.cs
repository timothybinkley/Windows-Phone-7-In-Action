...
namespace ODataWebTests
{
    ...
    {
        String nwServiceRoot = "http://services.odata.org/Northwind/Northwind.svc/";
        String odServiceRoot = "http://services.odata.org/(S(sessionid))/OData/OData.svc/";
        ...
        public void UpdateComplexTypeValueToObjectProperty()
        {
            ...
            Assert.IsNotNull(ex);
            Assert.IsTrue(ex.Message.Contains("Invalid value set for property \"Rating\""));
        }
